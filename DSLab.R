...
data1 <- read.csv("E:/Jcomponent big data/pro1.csv")
data2 <- read.csv("E:/Jcomponent big data/pro2.csv")
...
rainfallavailabledata <- read.csv("E:/Jcomponent big data/MaharashtrastateRainfall.csv")
...
croprainfalltempdata <- read.csv("E:/Jcomponent big data/CropRequiredTemperature.csv")
...
areaproductiondata <- read.csv("E:/Jcomponent big data/CropData.csv")
...
abline(lm(subval$Production~subval$Area))
